...
export default function MarketFeasibilityStudyShipRepairFacilityWestCoastPage() {
  return (
        ...
        <div className="container mx-auto px-4">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            <nav className="text-sm text-blue-200 mb-4">
              ...
              <span className="mx-2">›</span>
              <span className="text-white">Market feasibility study for setting up ship repair facility on west coast of India</span>
            </nav>
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Market feasibility study for setting up ship repair facility on west coast of India</h1>
          </motion.div>
        </div>
      </section>
