...
export default function KnowledgeCentreShippingPage() {
  return (
    <div className="container mx-auto px-4 py-12 prose max-w-3xl">
      ...
      <h2>Ship survey and classification</h2>
      <p>
        Ship survey concentrates on ship classification societies that register the ships under a particular class and flag.
      </p>
      <p>
        The technical rules, regulations, standards, guidelines and associated surveys and inspections covering the design, construction and through-life compliance of a ship&apos;s structure and essential engineering and electrical system are the main concerns of the classification societies.
      </p>
      <p>
        International Maritime Organization (IMO), through their various conventions requires certification that the above mentioned elements are satisfactory for the service for which the ship is intended. To attain the highest structural and engineering standards in the merchant ships, classification societies form the basis on which the statutory certification is issued. It also provides the technical support, compliance verification and research and development. Classification of ships includes three stages of verification:
      </p>
      <ul>
        <li>During construction, to ensure that the approved plans are followed, approved material and components are properly installed, good workmanship practised and applied, and the rules adhered to.</li>
        <li>Periodic surveys are carried out to ensure the continued compliance of rules after the construction of the ship. These include various surveys of hull and machinery on a continuing basis.</li>
        <li>Existing ships can be classified, which are not built under the supervision of the particular classification societies only after ensuring their quality standards according to the standards of that classification society.</li>
      </ul>
      <p>
      ...
      <h2>Ship chandlers, bunker and supplies</h2>
      <p>
