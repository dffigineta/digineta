        ...
        <div className="max-w-5xl mx-auto space-y-8">
          ...
          >
            <Card className="border-0 shadow-xl">
              <CardHeader>
                <CardTitle className="text-3xl text-white">Digital Transformation in Maritime</CardTitle>
              </CardHeader>
          ...
          >
            <Card className="border-0 shadow-xl">
              <CardHeader>
                <CardTitle className="text-3xl text-white">Digital Maritime Platforms</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2">Freight & Charter Platforms</h3>
                  <p className="text-lg text-[#cbd5e1] leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2">Port Community Systems (PCS)</h3>
                  <p className="text-lg text-[#cbd5e1] leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2">Vessel Tracking Systems</h3>
                  <p className="text-lg text-[#cbd5e1] leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2">Blockchain Platforms</h3>
                  <p className="text-lg text-[#cbd5e1] leading-relaxed">
          ...
          >
            <Card className="border-0 shadow-xl">
              <CardHeader>
                <CardTitle className="text-3xl text-white">Online Maritime Information Resources</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2">Industry News & Publications</h3>
                  <p className="text-lg text-[#cbd5e1] leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2">Market Intelligence Platforms</h3>
                  <p className="text-lg text-[#cbd5e1] leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2">Regulatory & Classification Society Websites</h3>
                  <p className="text-lg text-[#cbd5e1] leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2">Maritime E-Learning Platforms</h3>
                  <p className="text-lg text-[#cbd5e1] leading-relaxed">
          ...
          >
            <Card className="border-0 shadow-xl">
              <CardHeader>
                <CardTitle className="text-3xl text-white">Maritime Connectivity Solutions</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <p className="text-lg text-[#cbd5e1] leading-relaxed">
          ...
          >
            <Card className="border-0 shadow-xl bg-gradient-to-br from-blue-50 to-cyan-50">
              <CardHeader>
                <CardTitle className="text-3xl text-white">Maritime Cybersecurity</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <p className="text-lg text-[#cbd5e1] leading-relaxed">
