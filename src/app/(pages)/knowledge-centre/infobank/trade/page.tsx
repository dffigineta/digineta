        ...
        <div className="max-w-5xl mx-auto space-y-8">
          ...
          >
            <Card className="border-0 shadow-xl">
              <CardHeader>
                <CardTitle className="text-3xl text-white">Global Trade Overview</CardTitle>
              </CardHeader>
          ...
          >
            <Card className="border-0 shadow-xl">
              <CardHeader>
                <CardTitle className="text-3xl text-white">India&apos;s International Trade</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <p className="text-lg text-[#cbd5e1] leading-relaxed">
          ...
          >
            <Card className="border-0 shadow-xl">
              <CardHeader>
                <CardTitle className="text-3xl text-white">Trade Documentation & Procedures</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <p className="text-lg text-[#cbd5e1] leading-relaxed">
                ...
                <div className="space-y-3">
                  <div>
                    <h3 className="text-xl font-semibold text-white mb-2">Bill of Lading (B/L)</h3>
                    <p className="text-lg text-[#cbd5e1] leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-white mb-2">Commercial Invoice</h3>
                    <p className="text-lg text-[#cbd5e1] leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-white mb-2">Certificate of Origin (CoO)</h3>
                    <p className="text-lg text-[#cbd5e1] leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-white mb-2">Packing List</h3>
                    <p className="text-lg text-[#cbd5e1] leading-relaxed">
                      Details the contents of each package, weights, dimensions, and marks. Essential for customs inspection and cargo handling.
                    </p>
                  </div>
                  <div>
                    <h3 className="text-xl font-semibold text-white mb-2">Insurance Certificate</h3>
                    <p className="text-lg text-[#cbd5e1] leading-relaxed">
          ...
          >
            <Card className="border-0 shadow-xl">
              <CardHeader>
                <CardTitle className="text-3xl text-white">Incoterms (International Commercial Terms)</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <p className="text-lg text-[#cbd5e1] leading-relaxed">
          ...
          >
            <Card className="border-0 shadow-xl bg-gradient-to-br from-blue-50 to-cyan-50">
              <CardHeader>
                <CardTitle className="text-3xl text-white">Trade Regulations & Compliance</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2">Customs Procedures</h3>
                  <p className="text-lg text-[#cbd5e1] leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2">Trade Agreements</h3>
                  <p className="text-lg text-[#cbd5e1] leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2">Export Incentives</h3>
                  <p className="text-lg text-[#cbd5e1] leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2">Compliance & Regulations</h3>
                  <p className="text-lg text-[#cbd5e1] leading-relaxed">
