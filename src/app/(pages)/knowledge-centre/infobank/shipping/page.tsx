        ...
        <div className="max-w-5xl mx-auto space-y-8">
          ...
          >
            <Card className="border-0 shadow-xl">
              <CardHeader>
                <CardTitle className="text-3xl text-white">Global Shipping Overview</CardTitle>
              </CardHeader>
          ...
          >
            <Card className="border-0 shadow-xl">
              <CardHeader>
                <CardTitle className="text-3xl text-white">Indian Shipping Sector</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <p className="text-lg text-[#cbd5e1] leading-relaxed">
          ...
          >
            <Card className="border-0 shadow-xl">
              <CardHeader>
                <CardTitle className="text-3xl text-white">Types of Vessels</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2">Container Ships</h3>
                  <p className="text-lg text-[#cbd5e1] leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2">Bulk Carriers</h3>
                  <p className="text-lg text-[#cbd5e1] leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2">Tankers</h3>
                  <p className="text-lg text-[#cbd5e1] leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2">Specialized Vessels</h3>
                  <p className="text-lg text-[#cbd5e1] leading-relaxed">
          ...
          >
            <Card className="border-0 shadow-xl">
              <CardHeader>
                <CardTitle className="text-3xl text-white">Maritime Regulations & Safety</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <p className="text-lg text-[#cbd5e1] leading-relaxed">
          ...
          >
            <Card className="border-0 shadow-xl bg-gradient-to-br from-blue-50 to-cyan-50">
              <CardHeader>
                <CardTitle className="text-3xl text-white">Future of Shipping</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <p className="text-lg text-[#cbd5e1] leading-relaxed">
