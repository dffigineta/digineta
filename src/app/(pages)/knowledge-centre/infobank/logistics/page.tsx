        ...
        <div className="max-w-5xl mx-auto space-y-8">
          ...
          >
            <Card className="border-0 shadow-xl">
              <CardHeader>
                <CardTitle className="text-3xl text-white">Maritime Logistics Overview</CardTitle>
              </CardHeader>
          ...
          >
            <Card className="border-0 shadow-xl">
              <CardHeader>
                <CardTitle className="text-3xl text-white">Logistics Infrastructure</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2">Container Freight Stations (CFS)</h3>
                  <p className="text-lg text-[#cbd5e1] leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2">Inland Container Depots (ICD)</h3>
                  <p className="text-lg text-[#cbd5e1] leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2">Warehouses & Distribution Centers</h3>
                  <p className="text-lg text-[#cbd5e1] leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2">Logistics Parks</h3>
                  <p className="text-lg text-[#cbd5e1] leading-relaxed">
          ...
          >
            <Card className="border-0 shadow-xl">
              <CardHeader>
                <CardTitle className="text-3xl text-white">Indian Logistics Sector</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <p className="text-lg text-[#cbd5e1] leading-relaxed">
          ...
          >
            <Card className="border-0 shadow-xl">
              <CardHeader>
                <CardTitle className="text-3xl text-white">Multimodal Transportation</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <p className="text-lg text-[#cbd5e1] leading-relaxed">
          ...
          >
            <Card className="border-0 shadow-xl bg-gradient-to-br from-blue-50 to-cyan-50">
              <CardHeader>
                <CardTitle className="text-3xl text-white">Digital Logistics & Technology</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <p className="text-lg text-[#cbd5e1] leading-relaxed">
