...
export default function PrivacyPolicyPage() {
  return (
    <div className="container mx-auto px-4 py-12 prose max-w-3xl">
      ...
      <p>
        This site contains links to other sites. Digineta Consultancy is not responsible for the privacy practices or the content of such Web sites.
      </p>
      <h2>Security</h2>
      <p>
        This site has security measures in place to protect the loss, misuse, and/or alteration of information under our control. The data resides behind a firewall, with access restricted to authorized Digineta team.
      </p>
