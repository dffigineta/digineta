      ...
      <div className="container mx-auto px-4 py-20">
        <div className="max-w-4xl mx-auto prose prose-lg">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.1 }}>
            <Card className="border-0 shadow-xl mb-12">
              <CardHeader>
                <CardTitle className="text-3xl text-white">1. Digital-First Campaigning</CardTitle>
              </CardHeader>
              <CardContent>
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.2 }}>
            <Card className="border-0 shadow-xl mb-12">
              <CardHeader>
                <CardTitle className="text-3xl text-white">2. Issue-Based Politics Over Identity</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-lg text-[#cbd5e1] leading-relaxed">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.3 }}>
            <Card className="border-0 shadow-xl mb-12">
              <CardHeader>
                <CardTitle className="text-3xl text-white">3. Data-Driven Voter Engagement</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-lg text-[#cbd5e1] leading-relaxed">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.4 }}>
            <Card className="border-0 shadow-xl mb-12">
              <CardHeader>
                <CardTitle className="text-3xl text-white">4. Hyperlocal Content in Regional Languages</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-lg text-[#cbd5e1] leading-relaxed">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.5 }}>
            <Card className="border-0 shadow-xl mb-12">
              <CardHeader>
                <CardTitle className="text-3xl text-white">5. Grassroots Digital Volunteers</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-lg text-[#cbd5e1] leading-relaxed">
