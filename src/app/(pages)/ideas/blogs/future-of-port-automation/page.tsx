      ...
      <div className="container mx-auto px-4 py-20">
        <div className="max-w-4xl mx-auto prose prose-lg">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.1 }}>
            <Card className="border-0 shadow-xl mb-12">
              <CardHeader>
                <CardTitle className="text-3xl text-white">1. Automated Voter Outreach Workflows</CardTitle>
              </CardHeader>
              <CardContent>
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.2 }}>
            <Card className="border-0 shadow-xl mb-12">
              <CardHeader>
                <CardTitle className="text-3xl text-white">2. AI-Powered Content Generation</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-lg text-[#cbd5e1] leading-relaxed">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.3 }}>
            <Card className="border-0 shadow-xl mb-12">
              <CardHeader>
                <CardTitle className="text-3xl text-white">3. Booth-Level Execution Systems</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-lg text-[#cbd5e1] leading-relaxed">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.4 }}>
            <Card className="border-0 shadow-xl mb-12">
              <CardHeader>
                <CardTitle className="text-3xl text-white">4. Decision Dashboards</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-lg text-[#cbd5e1] leading-relaxed">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.5 }}>
            <Card className="border-0 shadow-xl mb-12">
              <CardHeader>
                <CardTitle className="text-3xl text-white">5. Post-Campaign Automation</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-lg text-[#cbd5e1] leading-relaxed">
